...
- [`sari_bh`](http://www.epinowcast.org/nowcastdatasets/reference/SARI_BH.md)
...
- [`denguedat`](http://www.epinowcast.org/nowcastdatasets/reference/denguedat.md)
  : Dengue fever individual-level reporting data from Puerto Rico (USA)
  1990-2010
...
- [`flusight`](http://www.epinowcast.org/nowcastdatasets/reference/flusight.md)
  : USA's National Healthcare Safety Network (NHSN) Weekly Hospital
  Respiratory Data from FluSight, 2022 – 2026
- [`germany_covid19_hosp`](http://www.epinowcast.org/nowcastdatasets/reference/germany_covid19_hosp.md)
  : Incident COVID-19 hospitalizations indexed by the date of positive
...
- [`mers_korea_2015`](http://www.epinowcast.org/nowcastdatasets/reference/mers_korea_2015.md)
  : Middle East Respiratory Syndrome (MERS-CoV) outbreak in South Korea,
  2015
